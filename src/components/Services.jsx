...
const Services = () => {
    const servicesData = [
        {
            title: 'Advertising',
            des:'We turn bold ideas into powerful digital solutions that connect, engage...',
        ...
        {
            title: 'Social media',
            des:'We help you build a strong social media presence and engage with your audience.',
  ...
  return (
    <div  id='services' className = 'relative flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
        ...
        <Title title='How can we help?' des='From strategy to execution, we craft digital solutions that move your business forward.'/>
